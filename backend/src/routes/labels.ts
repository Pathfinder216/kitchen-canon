...
const createLabelSchema = z.object({
  type: z.enum(['equipment', 'makeAhead']),
...
router.post(
  ...
  asyncHandler(async (req, res) => {
    ...
    // Replace manually-assigned labels; preserve auto-generated dietary/allergen labels
    await prisma.$transaction([
      prisma.recipeLabel.deleteMany({ where: { recipeId: id, isAutoGenerated: false } }),
